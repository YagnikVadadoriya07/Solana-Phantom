          ...
          >
            <div data-v-0f1a40d0 className="flex">
              <div data-v-0f1a40d0 className="w-1/4">
                ...
                <div
                  data-v-0f1a40d0
                  className="text-sm fontSetText text-center text-gray-dark dark:text-gray-regular font-medium"
                >
                  Enter Tent (2/2)
              ...
              <div data-v-0f1a40d0 className="w-1/4">
                ...
                <div
                  data-v-0f1a40d0
                  className="text-sm fontSetText text-center text-blue-meta font-bold"
                >
                  Select Assets
                  {/**/}
                </div>
              ...
              <div data-v-0f1a40d0 className="w-1/4">
                ...
                <div
                  data-v-0f1a40d0
                  className="text-sm fontSetText text-center text-gray-darkest dark:text-gray-dark"
                >
                  Confirm Tx
                  {/**/}
                </div>
              ...
              <div data-v-77e3ed07 className="flex gap-2.5">
                ...
                <div data-v-77e3ed07>
                  <button
                    ...
                    className="text-blue-dark dark:text-gray-regular hover:bg-gray-fair bg-gray-light dark:bg-blue-darkest dark:hover:bg-blue-regular rounded-lg p-2 transition-colors duration-150 ease-in-out"
                  >
                    {show ? (
                      <svg
                        data-v-d75a0d8c
      ...
      >
        <div data-v-1f7394e8 className="trade-container flex flex-col">
          ...
          <div
            data-v-6f779df4
            data-v-1f7394e8
            className="flex flex-col bg-white dark:bg-blue-darkest rounded-2xl flex-grow"
            style={{ "min-height": "0px" }}
          >
            <div
              data-v-6f779df4
              className="h-full flex flex-col justify-center text-gray-500 "
            >
              <div data-v-6f779df4 className="text-center mb-5">
                <h1
                  data-v-6f779df4
                  className="text-2xl fontSetLeave font-bold text-blue-dark dark:text-blue-light mb-1"
                >
                  This Tent is now Closed.
                </h1>{" "}
                <span
                  data-v-6f779df4
                  className="text-base fontSetText font-medium text-gray-dark dark:text-gray-light"
                >
                  No funds or assets have been moved.
                </span>
              </div>{" "}
              <div
                data-v-6f779df4
                className="mx-auto text-center fontSetLeave leading-150 text-lg font-bold px-4 py-1.5 rounded-lg bg-gray-light dark:bg-blue-darker text-blue-dark dark:text-gray-lightest my-5"
              >
                <i data-v-6f779df4 className="fas fa-heart-broken" />
                You have left the tent.
              </div>{" "}
              <div data-v-6f779df4 className="text-center mt-3">
                <button
                  data-v-6f779df4
                  onClick={() => navigate("/dashboard/:wallet")}
                  className="text-lg fontSetLeave rounded-lg hover:bg-opacity-20 hover:bg-yellow border-2 border-yellow box-border text-blue-dark dark:text-yellow py-1.5 px-4 font-bold"
                >
                  Go Back to the Camp 🏕️
                </button>
              </div>
            </div>
          </div>
        ...
        <div data-v-77d1d4d5 className="grid grid-cols-footer">
          <div data-v-77d1d4d5 className="justify-between flex flex-col">
            ...
            <div
              ...
              style={{ height: "157px", "margin-bottom": "10px" }}
            >
              <div
                data-v-77d1d4d5
                className="bg-gray-lightest dark:bg-blue-darker rounded-lg p-1.5 absolute right-0 top-0 bottom-0"
              >
                <a
                  data-v-77d1d4d5
                ...
                >
                  ...
                  >
                    <p
                      data-v-77d1d4d5
                      className="text-base leading-tight text-center font-medium text-blue-dark dark:text-gray-lightest w-full"
                    >
                      0
                    </p>{" "}
                    <p
          ...
          >
            <div data-v-77d1d4d5 className="mx-auto relative flex items-center">
              <p
                data-v-77d1d4d5
                className="absolute w-48 text-center text-base font-bold text-blue-dark dark:text-gray-lightest -top-7"
                style={{
                  "-webkit-transform": "translate(-73px, -4px)",
                  "-ms-transform": "translate(-73px, -4px)",
              ...
              <div
                data-v-77d1d4d5
                className="separator-icon w-12 h-12 rounded-full flex justify-center items-center bg-gray-lightest dark:bg-blue-darker"
              >
                <img
                  data-v-77d1d4d5
          ...
          <div data-v-77d1d4d5 className="justify-between flex flex-col">
            ...
            >
              <div
                data-v-77d1d4d5
                className="bg-gray-lightest dark:bg-blue-darker rounded-lg p-1.5 absolute top-0 bottom-0"
              >
                <a
                  data-v-77d1d4d5
                  href="javascript:void(0)"
              ...
              <div
                ...
                style={{ "margin-right": "0px", "margin-left": "132px" }}
              >
                <div data-v-77d1d4d5 className="flex w-full flex-nowrap">
                  <div
                    data-v-77d1d4d5
