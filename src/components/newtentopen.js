...
const NewTentOpen = () => {
  ...
  function textcopied() {
    toast.info("Tent ID copied to clipboard!", {
      position: "top-right",
      autoClose: 5000,
      ...
      >
        <div data-v-1f7394e8 className="trade-container flex flex-col">
          ...
          >
            ...
            <h1
              data-v-0bbba0cb
              className="text-xl fontSetLeave m-2 font-bold text-gray-darkest dark:text-gray-100 text-center"
            >
              Welcome to your Tent!
            </h1>
            <div data-v-0bbba0cb className="text-center">
              <p
                data-v-0bbba0cb
                className="text-lg fontSetLeave font-bold text-blue-700"
              >
                We are now waiting for a partner
                <i
                  data-v-0bbba0cb
                  className="ml-1 align-middle opacity-70 fas fa-spinner fa-pulse"
                />
              </p>
              <p
                data-v-0bbba0cb
                className="mt-2.5 mb-4 leading-150 text-[#828282] dark:text-gray-regular text-base"
              >
                Once your partner joins you will be
                <br data-v-0bbba0cb />
                able to select and trade assets.
              </p>
              <div data-v-0bbba0cb className>
                <CopyToClipboard onCopy={textcopied} text={tentid}>
                  <button
                    data-v-0bbba0cb
                    type="button"
                    content="Share the ID with your trading partner to invite them to your Tent"
                    className="rounded-lg fontSetLeave text-lg bg-[#FFB23C] hover:bg-opacity-80 box-border leading-150 text-blue-dark py-1 px-4 font-bold"
                  >
                    Copy Tent ID
                    <i
                      data-v-0bbba0cb
                      className="far text-base fa-clone ml-1"
                    />
                  </button>
                </CopyToClipboard>
                <input type="hidden" value={tentid} />
              </div>
            </div>
          </div>
        </div>
            ...
            >
              ...
              >
                <h1 className="text-xl text-blue-dark font-bold dark:text-white">
                  Enter <strong className="fontSetLeave">SOCIETY</strong>{" "}
                  quantity
                </h1>
              </div>
              <h3 className="text-lg font-bold fontSetLeave">
                Available : 7108358627
              </h3>
            </h1>{" "}
            <p
              data-v-77e3ed07
